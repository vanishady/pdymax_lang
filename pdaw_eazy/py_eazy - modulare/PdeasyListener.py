...
class PdeasyListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PdeasyParser#node_expr.
    def enterNode_expr(self, ctx:PdeasyParser.Node_exprContext):
        pass

    # Exit a parse tree produced by PdeasyParser#node_expr.
    def exitNode_expr(self, ctx:PdeasyParser.Node_exprContext):
        pass
